...
namespace IMS.DAL.Migrations
{
    ...
    [Migration("20241227200348_AddItemDescription")]
            ...
            modelBuilder.Entity("IMS.Common.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 27, 20, 3, 48, 16, DateTimeKind.Utc).AddTicks(6907),
                            Email = "admin@ims.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$WvwM2SgvVED0CUdt7a4xveDdjct3QodJjVt9KDaDw1CIRQAnGtoHC",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
