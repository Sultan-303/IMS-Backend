...
namespace IMS.DAL.Migrations
{
    ...
    [Migration("20241226153525_IHATEMIGRATIONS")]
            ...
            modelBuilder.Entity("IMS.Common.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 26, 15, 35, 24, 665, DateTimeKind.Utc).AddTicks(8771),
                            Email = "admin@ims.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$xaE/9i78fd7Hwle8ojwyLej9CXCul2GpDxJ0IAtOMMp8dfYg90kDy",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
