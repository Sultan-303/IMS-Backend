...
namespace IMS.DAL.Migrations
{
    ...
    [Migration("20241227183959_InitialCreate")]
            ...
            modelBuilder.Entity("IMS.Common.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 27, 18, 39, 59, 581, DateTimeKind.Utc).AddTicks(6021),
                            Email = "admin@ims.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$4uqBKUpzNrJbVVBD.HWgg.B3soFqXNddxLhQHtxDgHqweEkOTDiiC",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
