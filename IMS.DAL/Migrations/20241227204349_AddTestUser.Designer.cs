...
namespace IMS.DAL.Migrations
{
    ...
    [Migration("20241227204349_AddTestUser")]
            ...
            modelBuilder.Entity("IMS.Common.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 27, 20, 43, 48, 658, DateTimeKind.Utc).AddTicks(7843),
                            Email = "admin@ims.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$rLQ5Fprhg0tEiyqg0whSn.1WW.z5luGWn8BjVLdwfVT2ApduNErN6",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 12, 27, 20, 43, 48, 761, DateTimeKind.Utc).AddTicks(1219),
                            Email = "test@ims.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$ZSjUuToLetdpXFTKrp8LM.z28s/lJhI1QSdI6KIR2vu2hhCnvt3ny",
                            Role = "User",
                            Username = "testuser"
                        });
                });
